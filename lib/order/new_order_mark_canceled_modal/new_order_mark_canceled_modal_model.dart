...
import 'new_order_mark_canceled_modal_widget.dart'
    show NewOrderMarkCanceledModalWidget;
import 'package:flutter/material.dart';

class NewOrderMarkCanceledModalModel
    extends FlutterFlowModel<NewOrderMarkCanceledModalWidget> {
  ...
  // Model for modalMainDetailsComponent component.
  late ModalMainDetailsComponentModel modalMainDetailsComponentModel1;
  // Model for modalMainDetailsComponent component.
  late ModalMainDetailsComponentModel modalMainDetailsComponentModel2;
  ...
  void initState(BuildContext context) {
    ...
    modalDetailsTitleComponentModel2 =
        createModel(context, () => ModalDetailsTitleComponentModel());
    modalMainDetailsComponentModel1 =
        createModel(context, () => ModalMainDetailsComponentModel());
    modalMainDetailsComponentModel2 =
        createModel(context, () => ModalMainDetailsComponentModel());
  ...
  void dispose() {
    ...
    modalMainDetailsComponentModel1.dispose();
    modalMainDetailsComponentModel2.dispose();
