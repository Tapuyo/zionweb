...
import 'new_order_mark_canceled_modal_model.dart';
export 'new_order_mark_canceled_modal_model.dart';

class NewOrderMarkCanceledModalWidget extends StatefulWidget {
  const NewOrderMarkCanceledModalWidget({
    super.key,
    int? updateStep,
  ...
  @override
  State<NewOrderMarkCanceledModalWidget> createState() =>
      _NewOrderMarkCanceledModalWidgetState();
}

class _NewOrderMarkCanceledModalWidgetState
    extends State<NewOrderMarkCanceledModalWidget> {
  late NewOrderMarkCanceledModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewOrderMarkCanceledModalModel());
                    ...
                    children: [
                      Expanded(
                        ...
                        child: FlutterFlowDropDown<String>(
                          ...
                          elevation: 2.0,
                          borderColor: FlutterFlowTheme.of(context).choco100,
                          borderWidth: 0.0,
                          borderRadius: 8.0,
