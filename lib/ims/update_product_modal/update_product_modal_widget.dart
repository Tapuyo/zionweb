...
import 'update_product_modal_model.dart';
export 'update_product_modal_model.dart';
...
class _UpdateProductModalWidgetState extends State<UpdateProductModalWidget> {
  late UpdateProductModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateProductModalModel());
    ...
    _model.productCodeFocusNode ??= FocusNode();
                  ...
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          if (!containerProductsRow!.archived!)
                            Container(
                              decoration: BoxDecoration(
                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() =>
                                          _model.isDataUploading_uploadData8n8 =
                                              true);
                                      ...
                                      if (selectedUploadedFiles.length ==
                                          ...
                                          downloadUrls.length ==
                                              selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFile_uploadData8n8 =
                                              selectedUploadedFiles.first;
                                          _model.uploadedFileUrl_uploadData8n8 =
                                              downloadUrls.first;
                                        });
                                      } else {
                                        safeSetState(() {});
                                  ...
                                  Container(
                                    ...
                                    child: Align(
                                      ...
                                      child: Padding(
                                        padding: EdgeInsets.all(8.0),
                                        child: Text(
                                          _model.productCodeTextController.text,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                fontFamily:
                                                ...
                                                TextFormField(
                                                  ...
                                                  cursorColor:
                                                      FlutterFlowTheme.of(
                                                          ...
                                                          .primaryText,
                                                  validator: _model
                                                      .productCodeTextControllerValidator
                                                      .asValidator(context),
                                                ),
                                              ].divide(SizedBox(height: 4.0)),
                                            ),
                              ...
                              onPressed: () async {
                                ...
                                await ProductsTable().update(
                                  data: {
                                    ...
                                    'price': int.tryParse(
                                        _model.productPriceTextController.text),
                                    'code':
                                        _model.productCodeTextController.text,
                                    'image': _model.productImage,
                                  },
