...
import 'archive_warehouse_modal_model.dart';
export 'archive_warehouse_modal_model.dart';

class ArchiveWarehouseModalWidget extends StatefulWidget {
  const ArchiveWarehouseModalWidget({
    super.key,
    int? updateStep,
    int? warehouseId,
  ...
  @override
  State<ArchiveWarehouseModalWidget> createState() =>
      _ArchiveWarehouseModalWidgetState();
}

class _ArchiveWarehouseModalWidgetState
    extends State<ArchiveWarehouseModalWidget> {
  late ArchiveWarehouseModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ArchiveWarehouseModalModel());
