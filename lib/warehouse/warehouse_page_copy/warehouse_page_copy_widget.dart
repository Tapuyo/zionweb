...
import 'warehouse_page_copy_model.dart';
export 'warehouse_page_copy_model.dart';

class WarehousePageCopyWidget extends StatefulWidget {
  const WarehousePageCopyWidget({super.key});

  static String routeName = 'WarehousePageCopy';
  static String routePath = '/warehousePageCopy';

  @override
  State<WarehousePageCopyWidget> createState() =>
      _WarehousePageCopyWidgetState();
}

class _WarehousePageCopyWidgetState extends State<WarehousePageCopyWidget>
    with TickerProviderStateMixin {
  late WarehousePageCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WarehousePageCopyModel());
