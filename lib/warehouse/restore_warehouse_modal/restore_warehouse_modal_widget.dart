...
import 'restore_warehouse_modal_model.dart';
export 'restore_warehouse_modal_model.dart';

class RestoreWarehouseModalWidget extends StatefulWidget {
  const RestoreWarehouseModalWidget({
    super.key,
    int? updateStep,
    int? warehouseId,
  ...
  @override
  State<RestoreWarehouseModalWidget> createState() =>
      _RestoreWarehouseModalWidgetState();
}

class _RestoreWarehouseModalWidgetState
    extends State<RestoreWarehouseModalWidget> {
  late RestoreWarehouseModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RestoreWarehouseModalModel());
