import '/calendar/dispatch_success_order_modal/dispatch_success_order_modal_widget.dart';
...
import 'dispatch_summary_modal_model.dart';
export 'dispatch_summary_modal_model.dart';

class DispatchSummaryModalWidget extends StatefulWidget {
  const DispatchSummaryModalWidget({
    super.key,
    int? updateStep,
  ...
  @override
  State<DispatchSummaryModalWidget> createState() =>
      _DispatchSummaryModalWidgetState();
}

class _DispatchSummaryModalWidgetState
    extends State<DispatchSummaryModalWidget> {
  late DispatchSummaryModalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DispatchSummaryModalModel());
                          ...
                          Row(
                            ...
                            children: [
                              Align(
                                ...
                                child: wrapWithModel(
                                  model: _model.modalDetailsTitleComponentModel,
                                ...
                                style: FlutterFlowTheme.of(context)
                                    ...
                                    .override(
                                      fontFamily: FlutterFlowTheme.of(context)
                                          .bodyMediumFamily,
                                      color:
                                          FlutterFlowTheme.of(context).black50,
                                      fontSize: 12.8,
                                      letterSpacing: 0.0,
                                      lineHeight: 1.2,
                                      useGoogleFonts:
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (dialogContext) {
                                      return Dialog(
                                        ...
                                        child:
                                            DispatchSuccessOrderModalWidget(),
                                      );
                                    },
                                  );
                                },
