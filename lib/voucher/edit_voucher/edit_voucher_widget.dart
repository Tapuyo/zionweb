...
import 'edit_voucher_model.dart';
export 'edit_voucher_model.dart';

class EditVoucherWidget extends StatefulWidget {
  const EditVoucherWidget({
    super.key,
  ...
  @override
  State<EditVoucherWidget> createState() => _EditVoucherWidgetState();
}

class _EditVoucherWidgetState extends State<EditVoucherWidget> {
  late EditVoucherModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditVoucherModel());

    _model.vcodeTextController ??=
        TextEditingController(text: widget.voucher?.code);
    _model.vcodeFocusNode ??= FocusNode();

    _model.vamountTextController ??=
        TextEditingController(text: widget.voucher?.amount?.toString());
    _model.vamountFocusNode ??= FocusNode();

    _model.vquantityTextController ??=
        TextEditingController(text: widget.voucher?.limit?.toString());
    _model.vquantityFocusNode ??= FocusNode();

    _model.birthdateTextController ??= TextEditingController(
        text: dateTimeFormat("yMMMd", widget.voucher?.expiry));
                  ...
                  children: [
                    ...
                    wrapWithModel(
                      ...
                      child: WizardStepWidget(
                        step: 2,
                        stepTitle: 'Summary',
                        bgColor: _model.index == 1
                            ? FlutterFlowTheme.of(context).choco100
                            : FlutterFlowTheme.of(context).choco4,
                        txtColor: _model.index == 1
                            ? FlutterFlowTheme.of(context).white100
                            : FlutterFlowTheme.of(context).choco100,
                      ),
                    ),
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              TextFormField(
                                                controller: _model
                                                    .vamountTextController,
                                                focusNode:
                                                    _model.vamountFocusNode,
                                                autofocus: false,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  isDense: true,
                                                ...
                                                cursorColor:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
                                                validator: _model
                                                    .vamountTextControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ].divide(SizedBox(height: 4.0)),
                                          ),
                                        ...
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              TextFormField(
                                                controller: _model
                                                    .vquantityTextController,
                                                focusNode:
                                                    _model.vquantityFocusNode,
                                                autofocus: false,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  isDense: true,
                                                ...
                                                cursorColor:
                                                    FlutterFlowTheme.of(context)
                                                        .primaryText,
                                                validator: _model
                                                    .vquantityTextControllerValidator
                                                    .asValidator(context),
                                              ),
                                            ].divide(SizedBox(height: 4.0)),
                                          ),
                                      ...
                                      children: [
                                        wrapWithModel(
                                          ...
                                          child: ModalDetailsComponentWidget(
                                            label: 'Voucher code',
                                            value:
                                                _model.vcodeTextController.text,
                                          ),
                                        ),
                                        wrapWithModel(
                                          model: _model
                                            ...
                                            data: {
                                              'created_at':
                                                  supaSerialize<DateTime>(
                                                      getCurrentTimestamp),
                                              'type': _model.vtypeValue,
                                              'expiry': supaSerialize<DateTime>(
                                                  _model.datePicked != null
                                                      ? _model.datePicked
                                                      : widget
                                                          .voucher?.expiry),
                                              'code': _model
                                                  .vcodeTextController.text,
                                              'active': true,
                                              'amount': double.tryParse(_model
                                                  .vamountTextController.text),
                                              'quantity': 0,
                                              'limit': int.tryParse(_model
                                                  .vquantityTextController
                                                  .text),
                                            },
                                            matchingRows: (rows) =>
